...
function(name)
{
  ...
  .Defunct("trace", "base",
    paste0("useDefaults is defunct, because it could potentially modify",
           " functions in other namespaces. Use trace(", name, ", edit=TRUE)",
           " to add a call to importDefaults(", name, ") to the first line",
           " of ", name, "."))
}
...
function(name)
{
  ...
  .Defunct("untrace", "base",
    paste0("unDefaults is defunct, because it could potentially modify",
           " functions in other namespaces. Use untrace(", name, ") instead."))
}
